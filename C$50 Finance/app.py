...
def buy():
    ...
    if request.method == "GET":
        ...
        if user_cash < transaction_value:
            return apology("Not Enough User Funds")
...
def add_cash():
    ...
    if request.method == "GET":
        ...
        if not new_cash:
            return apology("Funds not recieved")
...
def register():
    ...
    if request.method == "GET":
        ...
        if not username:
            return apology("Inavlid Username, Try again")
        if not password:
            return apology("Invalid Password, Try again")
        if not confirmation:
            return apology("Invalid Confirmation, Try again")
